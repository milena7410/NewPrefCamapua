<div class="form-group has-feedback">
    {!! Form::label('secretaria','Secretaria *',['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-7">
        {!! Form::text('secretaria',null,['class' => 'form-control input-transparent','required']) !!}
...
<div class="form-group">
    {!! Form::label('ativo','Ativar Secretaria?',['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-7">
