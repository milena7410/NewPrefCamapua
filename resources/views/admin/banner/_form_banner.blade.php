...
<div class="form-group has-feedback">
    <label for="image" class="col-sm-2 control-label">
        Banner*
        <span class="help-block">Resolução: 1920X400</span>
    </label>

    <div class="col-sm-7">
        {!! Form::file('banner',['class' => 'form-control','required','accept' => 'image/*']) !!}
...
<div class="form-group">
    {!! Form::label('ativo','Ativar Banner?',['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-7">
