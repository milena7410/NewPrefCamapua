...
@section('content')
    <div class="main-container">
        <div class="page-header font-header"> Páginas Institucional</div>
        <ol class="breadcrumb">
            <li><a href="#">Páginas</a></li>
            <li class="active">Institucionais</li>
        </ol>
        ...
        <div class="content-wrap">
            ...
            <div class="panel panel-default">
                <div class="panel-heading font-header">Formulário de Cadastro de Nova Página</div>
                <div class="panel-body">
                    {!! Form::open(['route' => 'admin.pagina.store', 'method' => 'post','class' => 'form-horizontal font-12']) !!}
