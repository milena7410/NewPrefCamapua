...
@section('content')
    <div class="main-container">
        <div class="page-header font-header"> Editar de Link</div>
        <ol class="breadcrumb">
        ...
        <div class="content-wrap">
            <div class="panel panel-default">
                <div class="panel-heading font-header">Formulário de Edição de Link</div>
                <div class="panel-body">
                    @include('admin.errors._check_form')

                    @include('flash::message')

                    {!! Form::model($link,['route' => ['admin.link.update',$link->id],
                        ...
                        <div class="row">
                            <div class="col-sm-offset-4 col-sm-7">
                                <div class="btn-toolbar">
                                    ...
                                    <a href="{{route('admin.link.index')}}" class="btn btn-danger btn-flat">
                                        Cancelar
                                    </a>
                                </div>
                            </div>
